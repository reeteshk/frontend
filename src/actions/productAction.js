    ...
    (keyword = "", currentPage = 1, price = [0, 2500], category, ratings = 0) =>
        async (dispatch) => {
            try {
                ...
                let link = `https://getgrocery-api.onrender.com/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&ratings[gte]=${ratings}`;

                if (category) {
                    link = `https://getgrocery-api.onrender.com/api/v1/products?keyword=${keyword}&page=${currentPage}&price[gte]=${price[0]}&price[lte]=${price[1]}&category=${category}&ratings[gte]=${ratings}`;
                }
